...
public class Holidays : IHolidays
    {
        ...
        {
            IEnumerable<IHoliday> holidayList = _holidayList.Where(h => h.HasColaboratorAndHolidayPeriodsDuring(colaboratorId, startDate, endDate)); 
        ...
        public static int GetNumberOfHolidaysDaysForColaboratorDuringPeriod(long colaboratorId, DateOnly startDate, DateOnly endDate)
        {
            List<IHoliday> holidayList = new Holidays().getListHolidayFilterByColaborator(colaboratorId, startDate, endDate);
